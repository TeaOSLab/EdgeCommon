...
var file_service_node_proto_msgTypes = make([]protoimpl.MessageInfo, 113)
var file_service_node_proto_goTypes = []interface{}{
	...
	(*FindAllUpgradeNodesWithNodeClusterIdResponse_NodeUpgrade)(nil),      // 104: pb.FindAllUpgradeNodesWithNodeClusterIdResponse.NodeUpgrade
	(*ListNodeRegionInfoResponse_Info)(nil),                               // 105: pb.ListNodeRegionInfoResponse.Info
	(*FindNodeUAMPoliciesResponse_UAMPolicy)(nil),                         // 106: pb.FindNodeUAMPoliciesResponse.UAMPolicy
	(*FindNodeHTTPCCPoliciesResponse_HTTPCCPolicy)(nil),                   // 107: pb.FindNodeHTTPCCPoliciesResponse.HTTPCCPolicy
	(*FindNodeHTTP3PoliciesResponse_HTTP3Policy)(nil),                     // 108: pb.FindNodeHTTP3PoliciesResponse.HTTP3Policy
	(*FindNodeHTTPPagesPoliciesResponse_HTTPPagesPolicy)(nil),             // 109: pb.FindNodeHTTPPagesPoliciesResponse.HTTPPagesPolicy
	(*FindNodeScheduleInfoResponse_ScheduleInfo)(nil),                     // 110: pb.FindNodeScheduleInfoResponse.ScheduleInfo
	(*FindAllNodeScheduleInfoWithNodeClusterIdResponse_ScheduleInfo)(nil), // 111: pb.FindAllNodeScheduleInfoWithNodeClusterIdResponse.ScheduleInfo
	(*FindNodeWebPPoliciesResponse_WebPPolicy)(nil),                       // 112: pb.FindNodeWebPPoliciesResponse.WebPPolicy
	(*NodeLogin)(nil),                                                     // 113: pb.NodeLogin
	(*Node)(nil),                                                          // 114: pb.Node
	(*BasicNode)(nil),                                                     // 115: pb.BasicNode
	(*NodeInstallStatus)(nil),                                             // 116: pb.NodeInstallStatus
	(*DNSRoute)(nil),                                                      // 117: pb.DNSRoute
	(*SizeCapacity)(nil),                                                  // 118: pb.SizeCapacity
	(*NodeRegion)(nil),                                                    // 119: pb.NodeRegion
	(*NodeCluster)(nil),                                                   // 120: pb.NodeCluster
	(*RPCCountResponse)(nil),                                              // 121: pb.RPCCountResponse
	(*RPCSuccess)(nil),                                                    // 122: pb.RPCSuccess
}
var file_service_node_proto_depIdxs = []int32{
	113, // 0: pb.CreateNodeRequest.nodeLogin:type_name -> pb.NodeLogin
	114, // 1: pb.ListEnabledNodesMatchResponse.nodes:type_name -> pb.Node
	114, // 2: pb.FindAllEnabledNodesWithNodeClusterIdResponse.nodes:type_name -> pb.Node
	114, // 3: pb.FindEnabledNodeResponse.node:type_name -> pb.Node
	115, // 4: pb.FindEnabledBasicNodeResponse.node:type_name -> pb.BasicNode
	114, // 5: pb.FindAllEnabledNodesWithNodeGrantIdResponse.nodes:type_name -> pb.Node
	114, // 6: pb.FindAllNotInstalledNodesWithNodeClusterIdResponse.nodes:type_name -> pb.Node
	104, // 7: pb.FindAllUpgradeNodesWithNodeClusterIdResponse.nodes:type_name -> pb.FindAllUpgradeNodesWithNodeClusterIdResponse.NodeUpgrade
	116, // 8: pb.FindNodeInstallStatusResponse.installStatus:type_name -> pb.NodeInstallStatus
	113, // 9: pb.UpdateNodeLoginRequest.nodeLogin:type_name -> pb.NodeLogin
	48,  // 10: pb.FindAllEnabledNodesDNSWithNodeClusterIdResponse.nodes:type_name -> pb.NodeDNSInfo
	117, // 11: pb.NodeDNSInfo.routes:type_name -> pb.DNSRoute
	48,  // 12: pb.FindEnabledNodeDNSResponse.node:type_name -> pb.NodeDNSInfo
	114, // 13: pb.FindEnabledNodesWithIdsResponse.nodes:type_name -> pb.Node
	118, // 14: pb.UpdateNodeCacheRequest.maxCacheDiskCapacity:type_name -> pb.SizeCapacity
	118, // 15: pb.UpdateNodeCacheRequest.maxCacheMemoryCapacity:type_name -> pb.SizeCapacity
	105, // 16: pb.ListNodeRegionInfoResponse.infoList:type_name -> pb.ListNodeRegionInfoResponse.Info
	106, // 17: pb.FindNodeUAMPoliciesResponse.uamPolicies:type_name -> pb.FindNodeUAMPoliciesResponse.UAMPolicy
	107, // 18: pb.FindNodeHTTPCCPoliciesResponse.httpCCPolicies:type_name -> pb.FindNodeHTTPCCPoliciesResponse.HTTPCCPolicy
	108, // 19: pb.FindNodeHTTP3PoliciesResponse.http3Policies:type_name -> pb.FindNodeHTTP3PoliciesResponse.HTTP3Policy
	109, // 20: pb.FindNodeHTTPPagesPoliciesResponse.httpPagesPolicies:type_name -> pb.FindNodeHTTPPagesPoliciesResponse.HTTPPagesPolicy
	110, // 21: pb.FindNodeScheduleInfoResponse.scheduleInfo:type_name -> pb.FindNodeScheduleInfoResponse.ScheduleInfo
	111, // 22: pb.FindAllNodeScheduleInfoWithNodeClusterIdResponse.nodes:type_name -> pb.FindAllNodeScheduleInfoWithNodeClusterIdResponse.ScheduleInfo
	112, // 23: pb.FindNodeWebPPoliciesResponse.webPPolicies:type_name -> pb.FindNodeWebPPoliciesResponse.WebPPolicy
	114, // 24: pb.FindAllUpgradeNodesWithNodeClusterIdResponse.NodeUpgrade.node:type_name -> pb.Node
	119, // 25: pb.ListNodeRegionInfoResponse.Info.nodeRegion:type_name -> pb.NodeRegion
	120, // 26: pb.ListNodeRegionInfoResponse.Info.nodeCluster:type_name -> pb.NodeCluster
	...
	1,   // 94: pb.NodeService.createNode:output_type -> pb.CreateNodeResponse
	3,   // 95: pb.NodeService.registerClusterNode:output_type -> pb.RegisterClusterNodeResponse
	121, // 96: pb.NodeService.countAllEnabledNodes:output_type -> pb.RPCCountResponse
	121, // 97: pb.NodeService.countAllEnabledNodesMatch:output_type -> pb.RPCCountResponse
	6,   // 98: pb.NodeService.listEnabledNodesMatch:output_type -> pb.ListEnabledNodesMatchResponse
	8,   // 99: pb.NodeService.findAllEnabledNodesWithNodeClusterId:output_type -> pb.FindAllEnabledNodesWithNodeClusterIdResponse
	122, // 100: pb.NodeService.deleteNode:output_type -> pb.RPCSuccess
	122, // 101: pb.NodeService.deleteNodeFromNodeCluster:output_type -> pb.RPCSuccess
	122, // 102: pb.NodeService.updateNode:output_type -> pb.RPCSuccess
	13,  // 103: pb.NodeService.findEnabledNode:output_type -> pb.FindEnabledNodeResponse
	15,  // 104: pb.NodeService.findEnabledBasicNode:output_type -> pb.FindEnabledBasicNodeResponse
	17,  // 105: pb.NodeService.findCurrentNodeConfig:output_type -> pb.FindCurrentNodeConfigResponse
	18,  // 106: pb.NodeService.nodeStream:output_type -> pb.NodeStreamMessage
	18,  // 107: pb.NodeService.sendCommandToNode:output_type -> pb.NodeStreamMessage
	122, // 108: pb.NodeService.updateNodeStatus:output_type -> pb.RPCSuccess
	122, // 109: pb.NodeService.updateNodeIsInstalled:output_type -> pb.RPCSuccess
	23,  // 110: pb.NodeService.installNode:output_type -> pb.InstallNodeResponse
	25,  // 111: pb.NodeService.upgradeNode:output_type -> pb.UpgradeNodeResponse
	27,  // 112: pb.NodeService.startNode:output_type -> pb.StartNodeResponse
	29,  // 113: pb.NodeService.stopNode:output_type -> pb.StopNodeResponse
	31,  // 114: pb.NodeService.uninstallNode:output_type -> pb.UninstallNodeResponse
	122, // 115: pb.NodeService.updateNodeConnectedAPINodes:output_type -> pb.RPCSuccess
	121, // 116: pb.NodeService.countAllEnabledNodesWithNodeGrantId:output_type -> pb.RPCCountResponse
	35,  // 117: pb.NodeService.findAllEnabledNodesWithNodeGrantId:output_type -> pb.FindAllEnabledNodesWithNodeGrantIdResponse
	121, // 118: pb.NodeService.countAllNotInstalledNodesWithNodeClusterId:output_type -> pb.RPCCountResponse
	37,  // 119: pb.NodeService.findAllNotInstalledNodesWithNodeClusterId:output_type -> pb.FindAllNotInstalledNodesWithNodeClusterIdResponse
	121, // 120: pb.NodeService.countAllUpgradeNodesWithNodeClusterId:output_type -> pb.RPCCountResponse
	41,  // 121: pb.NodeService.findAllUpgradeNodesWithNodeClusterId:output_type -> pb.FindAllUpgradeNodesWithNodeClusterIdResponse
	43,  // 122: pb.NodeService.findNodeInstallStatus:output_type -> pb.FindNodeInstallStatusResponse
	122, // 123: pb.NodeService.updateNodeLogin:output_type -> pb.RPCSuccess
	121, // 124: pb.NodeService.countAllEnabledNodesWithNodeGroupId:output_type -> pb.RPCCountResponse
	47,  // 125: pb.NodeService.findAllEnabledNodesDNSWithNodeClusterId:output_type -> pb.FindAllEnabledNodesDNSWithNodeClusterIdResponse
	50,  // 126: pb.NodeService.findEnabledNodeDNS:output_type -> pb.FindEnabledNodeDNSResponse
	122, // 127: pb.NodeService.updateNodeDNS:output_type -> pb.RPCSuccess
	121, // 128: pb.NodeService.countAllEnabledNodesWithNodeRegionId:output_type -> pb.RPCCountResponse
	54,  // 129: pb.NodeService.findEnabledNodesWithIds:output_type -> pb.FindEnabledNodesWithIdsResponse
	56,  // 130: pb.NodeService.checkNodeLatestVersion:output_type -> pb.CheckNodeLatestVersionResponse
	122, // 131: pb.NodeService.updateNodeUp:output_type -> pb.RPCSuccess
	59,  // 132: pb.NodeService.downloadNodeInstallationFile:output_type -> pb.DownloadNodeInstallationFileResponse
	122, // 133: pb.NodeService.updateNodeSystem:output_type -> pb.RPCSuccess
	122, // 134: pb.NodeService.updateNodeCache:output_type -> pb.RPCSuccess
	63,  // 135: pb.NodeService.findNodeLevelInfo:output_type -> pb.FindNodeLevelInfoResponse
	65,  // 136: pb.NodeService.findNodeDNSResolver:output_type -> pb.FindNodeDNSResolverResponse
	122, // 137: pb.NodeService.updateNodeDNSResolver:output_type -> pb.RPCSuccess
	68,  // 138: pb.NodeService.findNodeDDoSProtection:output_type -> pb.FindNodeDDoSProtectionResponse
	122, // 139: pb.NodeService.updateNodeDDoSProtection:output_type -> pb.RPCSuccess
	71,  // 140: pb.NodeService.findNodeGlobalServerConfig:output_type -> pb.FindNodeGlobalServerConfigResponse
	73,  // 141: pb.NodeService.findEnabledNodeConfigInfo:output_type -> pb.FindEnabledNodeConfigInfoResponse
	121, // 142: pb.NodeService.countAllNodeRegionInfo:output_type -> pb.RPCCountResponse
	76,  // 143: pb.NodeService.listNodeRegionInfo:output_type -> pb.ListNodeRegionInfoResponse
	122, // 144: pb.NodeService.updateNodeRegionInfo:output_type -> pb.RPCSuccess
	79,  // 145: pb.NodeService.findNodeAPIConfig:output_type -> pb.FindNodeAPIConfigResponse
	122, // 146: pb.NodeService.updateNodeAPIConfig:output_type -> pb.RPCSuccess
	82,  // 147: pb.NodeService.findNodeUAMPolicies:output_type -> pb.FindNodeUAMPoliciesResponse
	84,  // 148: pb.NodeService.findNodeHTTPCCPolicies:output_type -> pb.FindNodeHTTPCCPoliciesResponse
	86,  // 149: pb.NodeService.findNodeHTTP3Policies:output_type -> pb.FindNodeHTTP3PoliciesResponse
	88,  // 150: pb.NodeService.findNodeHTTPPagesPolicies:output_type -> pb.FindNodeHTTPPagesPoliciesResponse
	90,  // 151: pb.NodeService.findNodeScheduleInfo:output_type -> pb.FindNodeScheduleInfoResponse
	122, // 152: pb.NodeService.updateNodeScheduleInfo:output_type -> pb.RPCSuccess
	122, // 153: pb.NodeService.resetNodeActionStatus:output_type -> pb.RPCSuccess
	94,  // 154: pb.NodeService.findAllNodeScheduleInfoWithNodeClusterId:output_type -> pb.FindAllNodeScheduleInfoWithNodeClusterIdResponse
	122, // 155: pb.NodeService.copyNodeActionsToNodeGroup:output_type -> pb.RPCSuccess
	122, // 156: pb.NodeService.copyNodeActionsToNodeCluster:output_type -> pb.RPCSuccess
	98,  // 157: pb.NodeService.findNodeTOAConfig:output_type -> pb.FindNodeTOAConfigResponse
	100, // 158: pb.NodeService.findNodeNetworkSecurityPolicy:output_type -> pb.FindNodeNetworkSecurityPolicyResponse
	102, // 159: pb.NodeService.findNodeWebPPolicies:output_type -> pb.FindNodeWebPPoliciesResponse
	122, // 160: pb.NodeService.updateNodeIsOn:output_type -> pb.RPCSuccess
	94,  // [94:161] is the sub-list for method output_type
	27,  // [27:94] is the sub-list for method input_type
...
func file_service_node_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_service_node_proto_msgTypes[111].Exporter = func(v interface{}, i int) interface{} {
		...
		file_service_node_proto_msgTypes[112].Exporter = func(v interface{}, i int) interface{} {
